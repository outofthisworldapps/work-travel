              ...
              >
                {(!isOvernight || isDeparturePart) && (
                  <div className="tl-f-main-wrap" style={{ display: 'flex', width: '100%', alignItems: 'center', justifyContent: 'flex-start', position: 'relative', height: '100%' }}>
                    ...
                    <div className="tl-f-rec" style={{ position: 'absolute', right: '4px', color: '#fff', fontSize: '0.7rem', fontWeight: 950 }}>{s.parentFlight.confirmation || ''}</div>
                  </div>
                )}
  ...
  return (
    <DndContext onDragStart={handleDragStart} onDragEnd={handleDragEnd}>
      <div className="travel-app dark">
        ...
        .tl-f-rec { position: absolute; top: 2px; right: 4px; font-size: 0.7rem; color: #fff; font-family: 'JetBrains Mono', monospace; font-weight: 700; background: rgba(0,0,0,0.3); padding: 1px 3px; border-radius: 3px; }
